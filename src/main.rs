...
fn main() -> Result<()> {
    let matches = App::new("bb-cli")
            ...
            App::new("pr")
                ...
                .subcommands(vec![
                    ...
                    SubCommand::with_name("status")
                        .about("Displays the status of the pull request"),
                    SubCommand::with_name("create")
                        .about("Opens create pull request screen in the browser"),
        ...
        .subcommand(App::new("repo").about("Repo commands").subcommands(vec![
